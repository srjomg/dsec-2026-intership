...
- [Инструкция](#инструкция)
  ...
  - [2. Извлечение секрета DPAPI\_SYSTEM из реестра](#2-извлечение-секрета-dpapi_system-из-реестра)
  - [3. Получаем GUID активного мастер-ключа](#3-получаем-guid-активного-мастер-ключа)
  - [4. Расшифровываем файлы мастер-ключа](#4-расшифровываем-файлы-мастер-ключа)
  - [5. Расшифровываем приватный RSA-ключ сертификата](#5-расшифровываем-приватный-rsa-ключ-сертификата)
  - [6. Загружаем оффлайн куст SOFTWARE в реестр](#6-загружаем-оффлайн-куст-software-в-реестр)
  - [7. Находим сертификаты в загруженном кусте](#7-находим-сертификаты-в-загруженном-кусте)
  - [8. Извлекаем сертификат](#8-извлекаем-сертификат)
  - [9. Конвертируем приватный ключ в PEM](#9-конвертируем-приватный-ключ-в-pem)
  - [10. Проверка соответствия ключей сертификату](#10-проверка-соответствия-ключей-сертификату)
- [Приложение](#приложение)
  - [Содержимое `cert.pem`](#содержимое-certpem)
  - [Содержимое `key.pem`](#содержимое-keypem)
  - [Структура дампа](#структура-дампа)
