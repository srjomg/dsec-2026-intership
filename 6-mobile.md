...
- [Технические детали](#технические-детали)
  - [F-C-1. Разрешение резервного копирования](#f-c-1-разрешение-резервного-копирования)
  - [F-C-2. Предсказуемый ключ шифрования AES](#f-c-2-предсказуемый-ключ-шифрования-aes)
  - [F-C-3. PIN и хеш пароля в незащищенном хранилище](#f-c-3-pin-и-хеш-пароля-в-незащищенном-хранилище)
  - [F-C-4. Обход аутентификации через глубокие ссылки](#f-c-4-обход-аутентификации-через-глубокие-ссылки)
  - [F-C-5. Обход пути при экспорте логов и отсутствие контроля доступа для провайдера логов](#f-c-5-обход-пути-при-экспорте-логов-и-отсутствие-контроля-доступа-для-провайдера-логов)
  - [F-H-6. Пароли и PIN в логах](#f-h-6-пароли-и-pin-в-логах)
  - [F-H-7. Статичная соль при шифровании пароля в хранилище](#f-h-7-статичная-соль-при-шифровании-пароля-в-хранилище)
  - [F-H-8. Режим AES/CBC не обеспечивает аутентификации](#f-h-8-режим-aescbc-не-обеспечивает-аутентификации)
  - [F-M-9. Брутфорс PIN без ограничений](#f-m-9-брутфорс-pin-без-ограничений)
  - [F-M-10. Пароль в буфере обмена](#f-m-10-пароль-в-буфере-обмена)
  - [F-M-11. Отсутствие флагов защиты для активностей с паролями](#f-m-11-отсутствие-флагов-защиты-для-активностей-с-паролями)
- [Сценарии атаки](#сценарии-атаки)
  - [Удаленная кража и расшифровка базы](#удаленная-кража-и-расшифровка-базы)
  - [Получение доступа к интерфейсу хранилища на разблокированном устройстве жертвы](#получение-доступа-к-интерфейсу-хранилища-на-разблокированном-устройстве-жертвы)
# Резюме
