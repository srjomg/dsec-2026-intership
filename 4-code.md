...
- [Технические детали](#технические-детали)
  - [F-H-1. RCE через SSTI при отправке платежного листа по почте (High)](#f-h-1-rce-через-ssti-при-отправке-платежного-листа-по-почте-high)
    - [Классификация](#классификация)
    - [Описание](#описание)
    - [Ограничения](#ограничения)
    - [Риск](#риск)
    - [Затронутая область](#затронутая-область)
    - [PoC](#poc)
    - [Исправление](#исправление)
  - [F-H-2. Захват аккаунта через сброс пароля (High)](#f-h-2-захват-аккаунта-через-сброс-пароля-high)
    - [Классификация](#классификация-1)
    - [Описание](#описание-1)
    - [Риск](#риск-1)
    - [Затронутая область](#затронутая-область-1)
    - [PoC](#poc-1)
    - [Исправление](#исправление-1)
  - [F-H-3. XSS на стороне сервера через механизм генерации PDF (High)](#f-h-3-xss-на-стороне-сервера-через-механизм-генерации-pdf-high)
    - [Классификация](#классификация-2)
    - [Описание](#описание-2)
    - [Ограничения](#ограничения-1)
    - [Риск](#риск-2)
    - [Затронутая область](#затронутая-область-2)
    - [PoC](#poc-2)
    - [Исправление](#исправление-2)
  - [F-M-4. Получение информации о других пользователях (IDOR) (Medium)](#f-m-4-получение-информации-о-других-пользователях-idor-medium)
    - [Классификация](#классификация-3)
    - [Описание](#описание-3)
    - [Риск](#риск-3)
    - [Затронутая область](#затронутая-область-3)
    - [PoC](#poc-3)
    - [Исправление](#исправление-3)
  - [F-M-5. Хранение секретов в небезопасном месте (Medium)](#f-m-5-хранение-секретов-в-небезопасном-месте-medium)
    - [Классификация](#классификация-4)
    - [Описание](#описание-4)
    - [Риск](#риск-4)
    - [Затронутая область](#затронутая-область-4)
    - [Исправление](#исправление-4)
- [Цепочки эксплуатации](#цепочки-эксплуатации)
  - [Захват аккаунта](#захват-аккаунта)
  - [RCE через аккаунт администратор](#rce-через-аккаунт-администратор)
  - [RCE через LFI через аккаунт пользователя](#rce-через-lfi-через-аккаунт-пользователя)
