...
- [Технические детали](#технические-детали)
  ...
  - [Medium](#medium)
    - [**F-M-1. Stored XSS в `/api/v1/profile`**](#f-m-1-stored-xss-в-apiv1profile)
      - [Классификации](#классификации-1)
      - [Описание](#описание-1)
      - [PoC](#poc-1)
      - [Риски](#риски-1)
      - [Рекомендации по устранению](#рекомендации-по-устранению-1)
    - [**F-M-2. Избыточное раскрытие данных / IDOR в `/api/v1/profile/{id}`**](#f-m-2-избыточное-раскрытие-данных--idor-в-apiv1profileid)
      - [Классификации](#классификации-2)
      - [Описание](#описание-2)
      - [PoC](#poc-2)
      - [Риски](#риски-2)
      - [Рекомендации по устранению](#рекомендации-по-устранению-2)
    - [**F-M-3. CSRF при смене почты в `/api/v1/account/change-email`**](#f-m-3-csrf-при-смене-почты-в-apiv1accountchange-email)
      - [Классификации](#классификации-3)
      - [Описание](#описание-3)
      - [PoC](#poc-3)
      - [Риски](#риски-3)
      - [Рекомендации по устранению](#рекомендации-по-устранению-3)
  - [Low](#low)
    - [**F-L-1. Использование предсказуемых ID пользователей**](#f-l-1-использование-предсказуемых-id-пользователей)
      - [Классификации](#классификации-4)
      - [Описание](#описание-4)
      - [Риски](#риски-4)
      - [Рекомендации по устранению](#рекомендации-по-устранению-4)
    - [**F-L-2. Отсутствие времени жизни JWT**](#f-l-2-отсутствие-времени-жизни-jwt)
      - [Классификации](#классификации-5)
      - [Описание](#описание-5)
      - [Риски](#риски-5)
      - [Рекомендации по устранению](#рекомендации-по-устранению-5)
  - [Informational](#informational)
    - [**F-I-1. Раскрытие типа серверного фреймворка через заголовок `X-Powered-By` в `/profile/{id}`**](#f-i-1-раскрытие-типа-серверного-фреймворка-через-заголовок-x-powered-by-в-profileid)
      - [Классификации](#классификации-6)
      - [Описание](#описание-6)
      - [Риски](#риски-6)
      - [Рекомендации по устранению](#рекомендации-по-устранению-6)
